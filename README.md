...
The file (*.xmlR*) with results can be found [here]( https://github.com/idea-statica/iom-examples/blob/master/IdeaStatiCa.Codes/Results/results.xmlR). Format is as follows:
...
You can download [idea project file](https://github.com/idea-statica/iom-examples/blob/master/IdeaStatiCa.Codes/SampleFiles/SteelFrame.idea) of our steel frame which can be open in IDEA StatiCa Designer.
