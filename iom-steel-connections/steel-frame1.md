...
Idea Connection project can be also generated by the webservice which runs in IDEA Cloud. More details are in the project [__IOM.SteelFrameWeb__](create-iom-cloud.md)
